...
def get_texture_SMPL(fname_img, fname_obj, fname_pkl, npath, obj_name, template_obj):
    ...
    cv2.imwrite(os.path.join(npath, 'T%s_all_V.png'%obj_name), timg)
    ...
    cv2.imwrite(os.path.join(npath, 'T%s_all_texture.png'%obj_name), texture)        
    ...
    cv2.imwrite(os.path.join(npath, 'T%s_mapped.png'%obj_name), img_f)        
    ...
    cv2.imwrite(os.path.join(npath, 'T%s_V.png'%obj_name), timg)  
    ...
    cv2.imwrite(os.path.join(npath, 'T%s_v_texture.png'%obj_name), texture)  
